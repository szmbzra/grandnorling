...
(function ($) {
	...
	"use strict";
$(".footer_wrapper").load("footer_menu.html");
	// Preload
...
// homepage  search button end
	...
	$('.owl-carousel.shimp_restaurant').owlCarousel({
	    loop:true,
	    margin:10,
	    nav:true,
	    dots:false,
